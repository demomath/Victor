...
/**
 * ClassName: CodeInjectProcessor
 * Description: 代码注入
 * Author: wudi41
 * Date: 2022/8/31 15:56
 */
class CodeInjectProcessor {
    InjectPluginInfo extension

    private CodeInjectProcessor(InjectPluginInfo extension) {
        this.extension = extension
    }

    static void insertInitCodeTo(InjectPluginInfo extension) {
        if (extension != null && !extension.classList.isEmpty()) {
            CodeInjectProcessor processor = new CodeInjectProcessor(extension)
